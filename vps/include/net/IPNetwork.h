...
public:
	 ...
	 */
	virtual ssize_t request(const Server& server, void* req, size_t reqlen, void* res, size_t reslen, int timeout=5)=0;
...
protected:
	/**
	 * The socket needed for every kind of communication.
	 */
	int sockfd;
};
